...
public class AuthenticationManager {
    ...
    public var userRole: String? = nil
    public var userId: Int? = nil
    public var userLoginId: String? = nil
    public var accessToken: String? = nil
    public var tokenExpiration: Date? = nil
    ...
    // 토큰 및 사용자 정보 저장
    public func saveAuthentication(accessToken: String, decodedToken: DecodedToken) {
