...
public enum ToMyongJiIOSFontFamily: Sendable {
  public enum GmarketSans: Sendable {
    ...
    public static let all: [ToMyongJiIOSFontConvertible] = [bold, light, medium]
  }
  public static let allCustomFonts: [ToMyongJiIOSFontConvertible] = [GmarketSans.all].flatMap { $0 }
...
public extension ToMyongJiIOSFontConvertible.Font {
  convenience init?(font: ToMyongJiIOSFontConvertible, size: CGFloat) {
